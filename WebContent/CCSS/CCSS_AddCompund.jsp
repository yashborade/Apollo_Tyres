...
<div>
<form action="CCSS_AddCompoundServlet" method="get" name="formAddNode" id="formAddNode">		
		...
		<div class="row py-3" style="border: 2px solid #a78cc2;">
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
				<label for="section" class="inp">
					<span class="label">Add Compound Package </span>
					<select class="form-control form-control-sm col-md-12"  style="width: 100%;" id="cmp_pkg" name="cmp_pkg" onchange="disForm(this)">	    	    	
			      		<option>--Select--</option>
			      		<option>CAP</option>
			      		<option>BASE</option>
			      		<option>WINGTIP</option>			      					      
			    	</select>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
				...
				<span class="label">Add Compound Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
					<input type="text" id="cmp_nam" name="cmp_nam" placeholder="&nbsp;" onblur="getEmpDetail()">
					<span class="border"></span>
				</label>
			</div>
