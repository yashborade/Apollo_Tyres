...
<%
	...
	String x = request.getAttribute("ref_patt").toString();
	System.out.println("pattern name :"+x);
%>
...
<form action="CCSS_AddCureCycleServlet" method="get" name="formEdit">		
	...
	<div class="container mt-3">
		<div class="row">
			...
			<th>Pattern Name :-</font> <input type="text" name="patt_nam" id="patt_nam" value= "<%=x %>" placeholder="Pattern Name " readonly style="height: 50px; width: 1135px"/></p></th>
