	...
	<div class="container mt-3">
		...
		<div class="row py-3" style="border: 2px solid #a78cc2;">
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
				...
				<span class="label">Enter New Design &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				<script>
					$(document).ready(function() {
					$("#new_des").autocomplete({
					width : 250,
					max : 10,
					delay : 100,
					minLength : 1,
					...
					<input type="text" id="new_des" name="new_des" placeholder="&nbsp;" onblur="getEmpDetail()">
					<span class="border"></span>
				</label>
			</div>
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
				<label for="nod_nam" class="inp">
				<span class="label">Enter Reference Design &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				<script>
					$(document).ready(function() {
					$("#ref_des").autocomplete({
					width : 250,
					max : 10,
					delay : 100,
					minLength : 1,
					...
					<input type="text" id="ref_des" name="ref_des" placeholder="&nbsp;" onblur="getEmpDetail()">
					<span class="border"></span>
				</label>
			</div>
