...
<script type="text/javascript">
		...
		{	
			if(element.value=="Modified"){
					...
					document.formEdit.action.value="Modified";
...
<form action="CCSS_AddCureCycleServlet" method="get" name="formEdit">		
		...
		<div class="row py-3" style="border: 2px solid #a78cc2;">
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
				...
				<script>
					...
					<input type="text" id="tyre_size" name="tyre_size" placeholder="&nbsp;" onblur="getEmpDetail()">
	...
	<div class="row">
			<div class="col-md-12 text-center">
				...
				<input class="my-3 py-2" type="button" value="Modified" id="Modify" onclick="submitValues(this)" style=" border:2px solid black; letter-spacing: 2px; font-weight:300; border-radius:20px 0  0 20px; background-color: #e94e0f; color:white; font-size: 14pt; " />
