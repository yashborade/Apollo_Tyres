...
<title>Revision Cure Cycle</title>
...
<form action="CCSS_AddCureCycleServlet" method="get" name="formEdit">		
	...
	<div class="container mt-3">
		<div class="row">
			...
			<tr>
			<th>Construction :-</font> <input type="text" name="cons" id="cons" value= "<%=groupData.getCONS() %>" placeholder="Construction " style="height: 50px; width: 1135px"/></p></th>
			</tr>
			<tr>
			<th>Cap :-</font> <input type="text" name="cap" id="cap" value= "<%=groupData.getTHR_CAP() %>" placeholder="Construction " style="height: 50px; width: 1135px"/></p></th>
			</tr>
			<tr>
			<th>Base :-</font> <input type="text" name="base" id="base" value= "<%=groupData.getTHR_BASE() %>" placeholder="Construction " style="height: 50px; width: 1135px"/></p></th>
			</tr>
			<tr>
			<th>WingTip :-</font> <input type="text" name="wingtip" id="wingtip" value= "<%=groupData.getTHR_WINGTIP() %>" placeholder="Construction " style="height: 50px; width: 1135px"/></p></th>
			</tr>
			<tr>
			<th>Tyre Code :-</font> <input type="text" name="tyre_code" id="tyre_code" value= "<%=groupData.getTYRE_CODE() %>" placeholder="Tyre Code " style="height: 50px; width: 1135px"/></p></th>
			</tr>
			<tr>
			...
			<tr>
			<th>Cure Code :-</font> <input type="text" name="cure_code" id="cure_code" value= "<%=groupData.getCURE_CODE() %>" placeholder="Cure Code " style="height: 50px; width: 1135px"/></p></th>
			</tr>
			</table>
	</div>
</div>
